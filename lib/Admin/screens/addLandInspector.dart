...
import '/Admin/widget/menu_item_tile.dart';
import 'package:provider/provider.dart';
import 'package:flutter_styled_toast/flutter_styled_toast.dart';

import '../constant/utils.dart';
import '../providers/MetamaskProvider.dart';
import '/Admin/Parkinglot/parkinglotdetail.dart';
import '/Admin/Parkinglot/home_screen.dart';
...
class _AddLandInspectorState extends State<AddLandInspector> {
  ...
  Menu(title: 'Money', icon: Icons.attach_money), // Utilisation de l'icône attach_money pour représenter l'argent
  Menu(title: 'Your Parkings', icon: Icons.local_parking), // Utilisation de l'icône local_parking pour représenter le parking
